...
# metricsMaxInMemory: maximum number of metrics kept when persistence is
# unavailable (metricsDbPath is ":memory:" or the database cannot be opened)
# - optional, default: 1000
metricsMaxInMemory: 1000

# metricsDbPath: SQLite file persisting request metrics across restarts
# - optional, default: "" (llama-swap.metrics.db next to the config file)
# - the directory must be writable (WAL sidecar files are created next to it)
# - set to ":memory:" to disable persistence
metricsDbPath: ""

# metricsRetentionDays: days to keep persisted metrics before pruning
# - optional, default: 1095 (3 years), set to 0 to keep forever
